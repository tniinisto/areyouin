...
<script type="text/javascript">
    if (screen.width < 574) {
        ...
        //SITE SPECIFIC
        var realmaster = "https://areyouin.azurewebsites.net/";
        ...
        if ( ((m !== null) || (n !== null)) || (host_url.match('back') != null) ) {
            ...
            if (r == true) {
                ...
                if (host_url.match(dev)) {
                    ...
                    if (host_url.match(local)) {
                        ...
                        if (host_url.match(master)) {
                            window.location = "https://areyouin.azurewebsites.net/mobile/default.html";
                        } else
                            if (host_url.match(realmaster)) {
                                window.location = "https://areyouin.azurewebsites.net/mobile/default.html";
                            }
            ...
            window.location = "https://areyouin.azurewebsites.net/";
        }
    }
</script>
