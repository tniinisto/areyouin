...
function getChartData() {
    ...
    $.getJSON(serviceURL + 'getChartData.php', function (data) {
        ...
        alert("FIRST ROW month/year: " + chartdata[0].month + " Your games: " + chartdata[0].participated  + " Games set: " + chartdata[0].games +
        " SECOND ROW month/year: " + chartdata[1].month + " Your games: " + chartdata[1].participated  + " Games set: " + chartdata[1].games);
