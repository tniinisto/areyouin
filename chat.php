                    ...
                    while($row = mysql_fetch_array($GLOBALS['chatresult'])) {
                        if($i < $limit) {                        
                            ...
                            echo "<tr class=\"chatrow\">";
                                ...
                                echo "<td width=\"500px\" height=\"50px\"><text class=\"commentArea1\">" . $published->format("j.n.Y H:i") . "</text><textarea readonly class=\"commentArea2\" id=\"area" . $i ."\">" . $row['comment'] . "</textarea></td>";
                            echo "</tr>";
