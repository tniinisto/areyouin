<?php
	...
	while($row = mysql_fetch_array($result))
	{
		...
		echo "<table border='0' class=\"atable2\">";
			echo "<tr>";
				echo "<td><div style=\"width: 20px\"><img width=\"40\" height=\"40\" src=\"images/" . $row['photourl'] . "\"></div></td>";
				echo "<td><div style=\"width: 220px\">" . $row['name'] . "</div></td>";
				if($row['areyouin'] == 0)
					echo "<td><div style=\"width: 20px\">OUT</div></td>";
				else
					echo "<td><div style=\"width: 20px\">IN</div></td>";
			echo "</tr>";
		echo "</table>";		
	}	
