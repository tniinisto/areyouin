            ...
            echo "<div id='more_events_content'>";
                ...
                echo "<article id='event_article_id' class='clearfix'>";
                    echo "<div class='divtable'>&nbsp";
                        ...
                        echo "<table class='atable_summary'>";
				            echo "<tr style='cursor: pointer;'>";
                                echo "<th style='padding-top: 5px; padding-bottom: 10px; text-align: center; color: #ffd800; text-decoration: underline;'><a href='#' style='color: #ffd800;'  onclick='getEvents(" . $call . ")'>More events available</a></th>";        
				            echo "</tr>";
    		            echo "</table>";  
                        echo "<table class='lastrow2'>";
				            echo "<tr>";
