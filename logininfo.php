<?php
    ...
    //echo $sql;
	echo "<font color=\"#ccc\">Welcome: </font>" . $row[name] . " <font color=\"#ccc\">Team: </font>" . $row[teamName] . "<font color=\"#0d1424\">" . $row[teamAdmin] . "<a href='http://areyouin.azurewebsites.net/'>logout</a></font>";
