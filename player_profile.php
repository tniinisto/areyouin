                ...
                <input type="submit" value="Edit information">
                    ...
                    <?php
                            ...
                            echo "<form id='player_edit' name='player_edit' method='post' action='updatePlayer.php' target='frame_player' onsubmit='refreshPlayerInfo();'>";
                                ...
                                echo "<input type='text' id='dialog_player_name' name='player_firstname' value='" . $player->firstname ."' required style='margin-bottom: 15px; width: 190px;' readonly></input>";
                                echo "</p>";

                                echo "<p style='margin: 0px; padding-top: 10px;'>";
                                echo "<label for='player_lastname' style='display: inline-block; width: 60px; text-align: right;'>Lastname:&nbsp</label>";                    
                                echo "<input type='text' id='dialog_player_name' name='player_lastname' value='" . $player->lastname ."' required style='margin-bottom: 15px; width: 190px;' readonly></input>";
                                echo "</p>";
