        ...
        if($ad==1) //Execute only for admin status
        {
            ...
            //Navigation///////////////////////////////////////////////////////////////////////////
                ...
                echo "<div id=\"team_content_id\" class=\"noshow\">";
                    ...
                    echo "<legend style='text-align: left;'><h1>Timezone</h1></legend>";
                        echo "<h2 id='team_timezone'>Team's current timezone is: " . $row_team['timezone'] . "</h2>";
                        ...
                        echo "<form id='timezones' method='get' target='frame_local' onsubmit=\"updateTimezone(timezone_select.value)\"";
                            ...
                            echo "<label><h2>Choose team's timezone:</h2></label>";                    
