        ...
        if(($ad==1) || ($registrar==1) ) //Execute only for admin and registrar status
        {
            ...
            //Navigation///////////////////////////////////////////////////////////////////////////
                ...
                echo "<div id=\"newgame_id\">";
                    ...
                    echo "<input type='datetime-local' id='gamestart_id' name='gamestart' required onchange='game_start()' </input>";
                    ...
                    echo "<input type='datetime-local' id='gameend_id' name='gamesend' required onchange='game_end()' </input>";
