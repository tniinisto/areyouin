        ...
        if(($ad==1) || ($registrar==1) ) //Execute only for admin and registrar status
        {
            ...
            //Navigation///////////////////////////////////////////////////////////////////////////
                ...
                echo "<div id=\"newgame_id\">";
                    ...
                    echo "<input type='datetime-local' id='gamestart_id' name='gamestart' required onchange='game_start()' value='" . date(('Y-m-d H:00'), strtotime('-1 hours')) . "' </input>";
                    ...
                    //echo "<input type=\"datetime-local\" id=\"gameend_id\" name=\"gamesend\" required value=\"" . date(('Y-m-d H:00'), strtotime('-1 hours')) . "\" onchange=\"game_end()\" required></input>";
                    echo "<input type='datetime-local' id='gameend_id' name='gamesend' required onchange='game_end()' value='" . date('Y-m-d H:00') . "' </input>";
